...
output "vpc_endpoint_sqs_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.sqs.*.id, [""]), 0)
}
...
output "vpc_endpoint_ecs_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.ecs.*.id, [""]), 0)
}
...
output "vpc_endpoint_ecs_agent_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.ecs_agent.*.id, [""]), 0)
}
...
output "vpc_endpoint_ecs_telemetry_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.ecs_telemetry.*.id, [""]), 0)
}
...
output "vpc_endpoint_sns_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.sns.*.id, [""]), 0)
}
...
output "vpc_endpoint_monitoring_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.monitoring.*.id, [""]), 0)
}
...
output "vpc_endpoint_elasticloadbalancing_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.elasticloadbalancing.*.id, [""]), 0)
}
...
output "vpc_endpoint_cloudtrail_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.cloudtrail.*.id, [""]), 0)
}
...
output "vpc_endpoint_logs_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.logs.*.id, [""]), 0)
}
...
output "vpc_endpoint_events_id" {
  ...
  value       = element(concat(aws_vpc_endpoint.events.*.id, [""]), 0)
}
