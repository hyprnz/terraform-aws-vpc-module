...
output "vpc_arn" {
  ...
  value = element(concat(aws_vpc.this.*.arn, [
    ""]), 0)
}
...
output "vpc_secondary_cidr_blocks" {
  ...
  value = [
    aws_vpc_ipv4_cidr_block_association.this.*.cidr_block]
}
...
output "database_subnet_group" {
  ...
  value = element(concat(aws_db_subnet_group.database.*.id, [
    ""]), 0)
}
...
output "redshift_subnet_arns" {
  ...
  value = [
    aws_subnet.redshift.*.arn]
}

output "redshift_subnets_cidr_blocks" {
  description = "List of cidr_blocks of redshift subnets"
  value = [
    aws_subnet.redshift.*.cidr_block]
}

output "redshift_subnet_group" {
  description = "ID of redshift subnet group"
  value = element(concat(aws_redshift_subnet_group.redshift.*.id, [
    ""]), 0)
}
...
output "elasticache_subnet_arns" {
  ...
  value = [
    aws_subnet.elasticache.*.arn]
}

output "elasticache_subnets_cidr_blocks" {
  description = "List of cidr_blocks of elasticache subnets"
  value = [
    aws_subnet.elasticache.*.cidr_block]
}
...
output "intra_subnet_arns" {
  ...
  value = [
    aws_subnet.intra.*.arn]
}

output "intra_subnets_cidr_blocks" {
  description = "List of cidr_blocks of intra subnets"
  value = [
    aws_subnet.intra.*.cidr_block]
}
...
output "database_route_table_ids" {
  ...
  value = length(aws_route_table.database.*.id)> 0  || length(aws_route_table.private.*.id) > 0 ?[
    coalescelist(aws_route_table.database.*.id, aws_route_table.private.*.id)] : []
}

output "redshift_route_table_ids" {
  description = "List of IDs of redshift route tables"
  value = length(aws_route_table.redshift.*.id)> 0  || length(aws_route_table.private.*.id) > 0 ? [
    coalescelist(aws_route_table.redshift.*.id, aws_route_table.private.*.id)] : []
}

output "elasticache_route_table_ids" {
  description = "List of IDs of elasticache route tables"
  value = length(aws_route_table.elasticache.*.id)> 0  || length(aws_route_table.private.*.id) > 0  ? [
    coalescelist(
...
output "public_network_acl_id" {
  ...
  value = element(concat(aws_network_acl.public.*.id, [
    ""]), 0)
}

output "private_network_acl_id" {
  description = "ID of the private network ACL"
  value = element(concat(aws_network_acl.private.*.id, [
    ""]), 0)
}

output "intra_network_acl_id" {
  description = "ID of the intra network ACL"
  value = element(concat(aws_network_acl.intra.*.id, [
    ""]), 0)
}

output "database_network_acl_id" {
  description = "ID of the database network ACL"
  value = element(concat(aws_network_acl.database.*.id, [
    ""]), 0)
}

output "redshift_network_acl_id" {
  description = "ID of the redshift network ACL"
  value = element(concat(aws_network_acl.redshift.*.id, [
    ""]), 0)
}

output "elasticache_network_acl_id" {
  description = "ID of the elasticache network ACL"
  value = element(concat(aws_network_acl.elasticache.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_sqs_id" {
  ...
  value = element(concat(aws_vpc_endpoint.sqs.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ssmmessages_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ssmmessages.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ec2messages_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ec2messages.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_kms_id" {
  ...
  value = element(concat(aws_vpc_endpoint.kms.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ecr_api_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ecr_api.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ecr_dkr_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ecr_dkr.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ecs_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ecs.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ecs_agent_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ecs_agent.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_ecs_telemetry_id" {
  ...
  value = element(concat(aws_vpc_endpoint.ecs_telemetry.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_sns_id" {
  ...
  value = element(concat(aws_vpc_endpoint.sns.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_monitoring_id" {
  ...
  value = element(concat(aws_vpc_endpoint.monitoring.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_elasticloadbalancing_id" {
  ...
  value = element(concat(aws_vpc_endpoint.elasticloadbalancing.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_elasticloadbalancing_network_interface_ids" {
  ...
  value = flatten(
  aws_vpc_endpoint.elasticloadbalancing.*.network_interface_ids,
  )
}
...
output "vpc_endpoint_cloudtrail_id" {
  ...
  value = element(concat(aws_vpc_endpoint.cloudtrail.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_logs_id" {
  ...
  value = element(concat(aws_vpc_endpoint.logs.*.id, [
    ""]), 0)
}
...
output "vpc_endpoint_events_id" {
  ...
  value = element(concat(aws_vpc_endpoint.events.*.id, [
    ""]), 0)
}
